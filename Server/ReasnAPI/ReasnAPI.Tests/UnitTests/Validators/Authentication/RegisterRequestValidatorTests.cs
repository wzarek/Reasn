...
public class RegisterRequestValidatorTests
{
    ...
    {
        var request = new RegisterRequest { Name = "" };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Name = new string('a', 65) };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Name = "123" };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Surname = "" };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Surname = new string('a', 65) };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Surname = "123" };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Username = new string('a', 65) };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Username = "user name" };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Email = new string('a', 256) };
        var result = _validator.Validate(request);
    ...
    [TestMethod]
    public void Validate_WhenEmptyPhone_ShouldReturnTrue()
    {
        var request = new RegisterRequest { Phone = "" };
        var result = _validator.Validate(request);

        Assert.IsFalse(result.Errors.Exists(
    ...
    {
        var request = new RegisterRequest { Phone = "invalid phone" };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Address = null };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Role = "" };
        var result = _validator.Validate(request);
    ...
    {
        var request = new RegisterRequest { Role = "invalid role" };
        var result = _validator.Validate(request);
